...
dp.sh.HighlightAll = function(regTargetClass, showGutter /* optional */, showControls /* optional */, collapseAll /* optional */, firstLine /* optional */, showColumns /* optional */)
{
	function FindValue()
	{
		var a = arguments;
	...
	function FindTagsByName(list, regTargetClass, tagName)
	{
		var tags = document.getElementsByTagName(tagName);
		for(var i=0; i<tags.length; i++) {
			if (regTargetClass.test(tags[i].className)) {
				list.push(tags[i]);
			}
		}
	}
	...
	// find 'pre' with className = regTargetClass, default is /css|js/
	FindTagsByName(elements, regTargetClass, 'pre');
	FindTagsByName(elements, regTargetClass, 'textarea');
...
dp.sh.Brushes.CSS = function()
{
	...
	this.Style =	'.dp-css .value { color: #ffa0a0; }' +
